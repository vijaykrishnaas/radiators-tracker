                        ...
                        <div className="row table-accordion-header align-items-end g-3">
                            <div className="col-12 col-md-4">
                                ...
                                <Selector
                                    ...
                                    onChange={(opt: any) => setSelectedMechanic(opt)}
                                />
                            </div>
                ...
                {!selectedMechanic && (
                    <div className="card card-shadow">
                        <div className="card-body text-center py-5 text-muted font-s14">
                            Select a mechanic to view their performance review
                        </div>
                    </div>
                )}

                {selectedMechanic && data && (
                    <>
                        {/* KPI cards */}
